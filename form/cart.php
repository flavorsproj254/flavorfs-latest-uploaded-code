                 ...
                 <table class="table">
                  <tbody>
                   ...
                   <?php
					  ...
					  <td>
					  <h5><i class="fas fa-shilling-sign"></i>&nbsp;<?php echo end($gtotal); ?></h5>
					  </td>
					  <td>
            ...
            <div class="tab-pane fade" id="manageaccount" role="tabpanel" aria-labelledby="manageaccount-tab">
			    <form method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
                      ...
                      <input type="tel" id="mobile" class="form-control" name="mobile" pattern="[0-9]{0-9}[0-9]{0-9}[0-9]{0-9}[0-9]{0-9}" value="<?php if(isset($fld_mobile)){ echo $fld_mobile;}?>" placeholder="" required>
                    </div>
